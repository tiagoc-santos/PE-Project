...
* todos os paises sejam representados por um símbolo e, além disso, os seguintes países: United Arab Emirates, Nepal, Comoros e Namibia, apareçam representados pelo símbolo e identificados pelo nome.
...
>i. O código em R, incluindo os comandos para leitura dos dados do ficheiro e a construção do gráfico propriamente dito.

>ii. O gráfico produzido.
...
>i. O código em R, que deve incluir os comandos para leitura e seleção dos dados do ficheiro.
...
Pergunta 4 Selecione uma opção:
...
Sejam (Z1,Z2,…,Zn+1) variáveis aleatórias independentes e com distribuição normal padrão. Prova-se que a variável aleatória,
